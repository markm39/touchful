...
var Log = {
  ...
  error(module, msg, isofile) {
    if (isofile == null ? void 0 : isofile.onError) {
...
}, _type = new WeakMap(), _a2.registryId = Symbol.for("BoxIdentifier"), _a2);
...
}, _a3.registryId = Symbol.for("SampleGroupEntryIdentifier"), _a3);
...
}, _a4.registryId = Symbol.for("SampleEntryIdentifier"), _a4);
...
var AudioSampleEntry = class extends SampleEntry {
  parse(stream) {
    ...
    const isQT = (_b = (_a282 = stream.isofile) == null ? void 0 : _a282.ftyp) == null ? void 0 : _b.major_brand.includes("qt");
    if (isQT) {
      if (this.version === 1) {
...
var ISOFile = class _ISOFile {
  ...
  static writeInitializationSegment(ftyp, moov, total_duration) {
    ...
    for (let i = 0; i < moov.traks.length; i++) {
      ...
      trex.default_sample_duration = ((_a282 = moov.traks[i].samples[0]) == null ? void 0 : _a282.duration) ?? 0;
  ...
  initializeSegmentation() {
    ...
    return {
      ...
      buffer: _ISOFile.writeInitializationSegment(
        this.ftyp,
        moov,
        (_b = (_a282 = this.moov) == null ? void 0 : _a282.mvex) == null ? void 0 : _b.mehd.fragment_duration
      )
    };
  }
  /**
...
var Descriptor = class _Descriptor {
  ...
  parseRemainingDescriptors(stream) {
    ...
    while (stream.getPosition() < start2 + this.size) {
      const desc = (_a282 = this.parseOneDescriptor) == null ? void 0 : _a282.call(this, stream);
...
var VTTin4Parser = class {
  parseSample(data) {
    ...
    while (!stream.isEof()) {
      ...
      if (cue.code === OK && ((_a282 = cue.box) == null ? void 0 : _a282.type) === "vttc") {
        cues.push(cue.box);
      }
    }
    return cues;
